...
def process_csv(filename):
  ...
  if (isStatsLoading || isSnippetsLoading) return <div>Loading...</div>;
  if (isStatsError || isSnippetsError) return <div>Error: {statsError.message} {snippetsError.message}</div>;
